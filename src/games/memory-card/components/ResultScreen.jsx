    ...
    <div style={styles.container}>
      ...
      <div style={styles.content}>
        ...
        <div style={styles.card}>
          ...
          <ScoreBar label="정확도" score={accuracy}   max={40} color="#1F3EE0" />
          <ScoreBar label="속도"   score={speed}      max={30} color="#FF8C00" />
          <ScoreBar label="효율성" score={efficiency} max={30} color="#00A86B" />
        </div>

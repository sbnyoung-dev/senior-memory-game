...
function getGrade(total) {
  if (total >= 90) return { emoji: '🧠', grade: '주의집중력 박사', message: '집중력이 매우 뛰어나요!' };
  if (total >= 75) return { emoji: '⭐', grade: '주의집중력 우수', message: '집중력이 좋으세요!' };
  if (total >= 60) return { emoji: '👍', grade: '주의집중력 양호', message: '꾸준히 하면 더 좋아져요!' };
  if (total >= 45) return { emoji: '💪', grade: '집중력 훈련중', message: '매일 조금씩 연습해봐요!' };
  return { emoji: '🌱', grade: '집중력 새싹', message: '잘 하셨어요!' };
}
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.scoreHeader}>
        <p style={styles.scoreLabel}>오늘의 주의집중력 점수</p>
      ...
      <div style={styles.content}>
        ...
        <div style={styles.encouragement}>
          ...
          <span style={styles.encourageText}>꾸준한 집중력 훈련이 뇌 건강의 비결이에요</span>
        </div>

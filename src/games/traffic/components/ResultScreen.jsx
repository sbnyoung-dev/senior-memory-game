...
function getGrade(total) {
  if (total >= 90) return { emoji: '🧠', grade: '전두엽 집행능력 박사', message: '규칙 전환이 매우 빠르네요!' };
  if (total >= 75) return { emoji: '⭐', grade: '전두엽 집행능력 우수', message: '규칙 전환을 잘 하세요!' };
  if (total >= 60) return { emoji: '👍', grade: '전두엽 집행능력 양호', message: '꾸준히 하면 더 좋아져요!' };
  if (total >= 45) return { emoji: '💪', grade: '전두엽 집행능력 훈련중', message: '매일 조금씩 연습해봐요!' };
  return { emoji: '🌱', grade: '전두엽 집행능력 새싹', message: '잘 하셨어요!' };
}
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.scoreHeader}>
        <p style={styles.scoreLabel}>오늘의 전두엽 집행능력 점수</p>
